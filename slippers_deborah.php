...
<title>Khromata :: Ruby Red Slipper - Deborah Lippmann</title>
...
<div id="topo">
        <div id="cabeça">
          <div class="avatarb"><img src="enamel/slippers_deborah_embalagem2.png" width="195" height="245" /></div>          
          <div id="back"><img src="imagem/background.jpg" width="614" height="237" /></div>
          <div class="avatar"></div><!--avatar-->
          <div id="cabeçalho">
                <h1>Ruby Red Slippers</h1>
                <h2>Deborah Lippmann</h2>
       	  </div><!--cabeçalho-->
...
<div id="atalhosocial">           
       <div id="social">
                              ...
                              <input type="hidden" value="Ruby Red Slippers" name="productname"/>
